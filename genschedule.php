...
<body>
<!--background-->
<h1 style="margin: 5px 0px 0px 5px; font-size: 30px; letter-spacing: 3px;"><img src="images/logo.png" /><br>PARAMOUNT SPECIALIST HOSPITAL & FERTILITY CENTER</h1>
    <div class="bg-agile">
	...
	<h2>Patient Schedule Generation</h2>
			<form action="schedule.php" method="post" target="_blank">
